...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_DEF = 267,                 // "def"
    TOK_IDENTIFIER = 268,          // "id"
    TOK_NUMBER = 269               // "number"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_startsymb = 16,                        // startsymb
        S_program = 17,                          // program
        S_top = 18,                              // top
        S_definition = 19,                       // definition
        S_external = 20,                         // external
        S_proto = 21,                            // proto
        S_idseq = 22,                            // idseq
        S_exp = 23,                              // exp
        S_idexp = 24,                            // idexp
        S_optexp = 25,                           // optexp
        S_explist = 26                           // explist
      };
    };
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::TOK_END
                   || (token::TOK_YYerror <= tok && tok <= token::TOK_DEF));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
